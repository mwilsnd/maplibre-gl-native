...
class DelegateFileSource : public FileSource {
public:
    DelegateFileSource(const ResourceOptions& resourceOptions, const ClientOptions& clientOptions);
    ~DelegateFileSource() override;
